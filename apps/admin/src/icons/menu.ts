...
export function renderMenuIcon(name?: string) {
  ...
  if (name === 'shop') {
    return () => IconBox({ children: h('svg', { viewBox: '0 0 24 24', fill: 'none', stroke: 'currentColor', 'stroke-width': '2', 'stroke-linecap': 'round', 'stroke-linejoin': 'round', width: '16', height: '16' }, [
