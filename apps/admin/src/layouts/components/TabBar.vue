<template>
  <div
    class="bg-white/80 dark:bg-[#0A1120]/80 backdrop-blur-md border-b border-gray-100 dark:border-gray-800/60 px-2 py-2.5 flex items-center gap-1 sticky top-0 z-10 shadow-sm transition-colors duration-300"
  >
    <!-- 左箭头 -->
    <div
