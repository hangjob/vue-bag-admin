...
import { d as defineComponent, l as ref, o as onMounted, X as createElementBlock, Y as createBaseVNode, F as Fragment, _ as renderList, W as openBlock, a3 as toDisplayString, w as watch, n as nextTick, R as resolveComponent, a0 as createBlock, a1 as withCtx, k as createVNode, u as createTextVNode, a4 as pushScopeId, a5 as popScopeId, a6 as defineAsyncComponent, c as reactive, j as computed, a7 as resolveDirective, t as withDirectives, S as createCommentVNode, E as toRaw, a8 as resolveDynamicComponent, a9 as toRefs, g as getCurrentInstance, aa as normalizeClass, O as mergeProps, N as h } from "./@vue-f3ca1b6f.js";
import { m as messageModel, A as Antd, n as notification } from "./ant-design-vue-8621340c.js";
import { Y as antIcons, _ as AppleOutlined, $ as AndroidOutlined, a0 as UploadOutlined, P as PlusOutlined } from "./@ant-design-10c9abc6.js";
/* empty css                        */import { c as createStore, u as useStore } from "./vuex-bb2f5e5b.js";
import { s as store_legacy } from "./store-e22b25f7.js";
import { l as lodash, _ } from "./lodash-0fe20078.js";
import { u as useRouter, a as useRoute, c as createRouter, b as createWebHashHistory } from "./vue-router-abde8f4b.js";
import { d as axios } from "./axios-c5bbbefe.js";
import { N as NProgress } from "./nprogress-e54c853a.js";
import { C as Chart, L as Liquid, m as measureTextWidth } from "./@antv-15af26e6.js";
import { h as hooks } from "./moment-f39140d2.js";
import { C as CryptoJS } from "./crypto-js-33836c9f.js";
import { m as mojs } from "./@mojs-1ff6c968.js";
import { i as init } from "./echarts-fffd6d3a.js";
import { W as LinearGradient } from "./zrender-cdd1d9d2.js";
import { X as XLSX } from "./xlsx-be779d30.js";
import { V as VMdEditor, g as githubTheme } from "./@kangc-04158a4a.js";
import { l as lib } from "./highlight.js-5d1de029.js";
import { e as entry_esm } from "./vue3-marquee-3097e0d6.js";
import { p as printJS } from "./print-js-49781bfc.js";
import { Q as Quill } from "./quill-f4ba861e.js";
import { u as useWebSocket } from "./@vueuse-fe55e91e.js";
import { V as VXETable, z as zhCN, H as Header, F as Footer, I as Icon, a as Filter, E as Edit, M as Menu, b as Export, K as Keyboard, c as Validator, C as Column, d as Colgroup, G as Grid, T as Tooltip, e as Toolbar, P as Pager, f as Form, g as FormItem, h as FormGather, i as Checkbox, j as CheckboxGroup, R as Radio, k as RadioGroup, l as RadioButton, S as Switch, m as Input, n as Select, O as Optgroup, o as Option, p as Textarea, B as Button, q as Modal, L as List, r as Pulldown, s as Table$1 } from "./vxe-table-57902609.js";
import { x as xeUtils } from "./xe-utils-a3a4c73c.js";
import { t as toClipboard } from "./@soerenmartius-2f8ee501.js";
import { p as plugin } from "./@braks-1429c1f4.js";
import { M as Mock } from "./mockjs-ecfa51ef.js";
  ...
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("div", _hoisted_1$J, [
      (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.items, (item, idx) => {
        ...
        }, toDisplayString(item.name), 9, _hoisted_2$x);
      }), 128))
    ])
  ]);
}
var Contextmenu = /* @__PURE__ */ _export_sfc(_sfc_main$M, [["render", _sfc_render$M], ["__scopeId", "data-v-033e127d"]]);
var locaStore = {
  suffix: "_webtime",
  all() {
    const d = {};
...
function setLocaStoreToken(data2) {
  locaStore.set("token", data2.token, data2.expiredTime);
}
const user = {
  namespaced: true,
  state: {
  ...
  mutations: {
    updateToken(state, data2) {
      setLocaStoreToken(data2);
    },
...
const addUniqueId = (arr2, prefix) => {
  arr2.forEach((item) => {
    if (isArray(item)) {
      addUniqueId(item, prefix);
    } else {
      item.id = lodash.exports.uniqueId(prefix);
      if (item.children) {
...
const findContainingObject = (tag, arr2) => {
  ...
  const deep = (tag2, arr22) => {
    arr22.filter((item) => {
      ...
      item.children && deep(tag2, item.children);
    });
  };
  deep(tag, arr2);
  return result;
...
const apiAppRouter = (params, config) => {
  return post("/appRouter", params, config);
};
const apiAddMenu = (params, config) => {
  return post("/addMenu", params, config);
};
const apiFindAll = (params, config) => {
  return post("/findAll", params, config);
};
const apiDeleteMenu = (params, config) => {
  return post("/deleteMenu", params, config);
};
const apiDeleteMenus = (params, config) => {
  return post("/deleteMenus", params, config);
};
const apiEditMenu = (params, config) => {
  return post("/editMenu", params, config);
};
const apiFindOne = (params, config) => {
...
function checkError(to, from, next) {
  !ignore.some((e) => to.path.indexOf(e) === 0) ? next("/login") : next();
}
...
class UserCanvasBg {
  constructor(parame) {
    ...
    this.options = __spreadValues({}, parame);
    this.userInfo = parame.userInfo || {};
    this.init();
  }
  init() {
    let canvas = this.options.el;
  ...
  circle() {
    this.loadImage(this.userInfo.userhead, (res) => {
      this.line({
  ...
  drawText(parame) {
    let { str, x, y, size, direction, color: color2 = "#fff", maxWidth } = parame;
    x = this.centerX + x;
    y = this.centerY + y;
...
const _withScopeId$b = (n) => (pushScopeId("data-v-a960b686"), n = n(), popScopeId(), n);
const _hoisted_1$I = {
  class: "canvas",
  ref: "canvas"
};
const _hoisted_2$w = { class: "hand" };
const _hoisted_3$r = ["src"];
const _hoisted_4$p = { class: "hand-name" };
const _hoisted_5$m = /* @__PURE__ */ createTextVNode(" Like Me ");
const _hoisted_6$l = /* @__PURE__ */ _withScopeId$b(() => /* @__PURE__ */ createBaseVNode("div", { class: "" }, null, -1));
function _sfc_render$L(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_yxs_view, { class: "about" }, {
    default: withCtx(() => [
      createBaseVNode("canvas", _hoisted_1$I, null, 512),
      createVNode(_component_a_row, { gutter: [16, 16] }, {
        default: withCtx(() => [
          createVNode(_component_a_col, {
            ...
            default: withCtx(() => [
              createVNode(_component_a_card, { title: "\u5173\u4E8E\u6211" }, {
                default: withCtx(() => [
                  createBaseVNode("div", _hoisted_2$w, [
                    createBaseVNode("img", {
                      src: _ctx.userinfo.userhead,
                      alt: ""
                    }, null, 8, _hoisted_3$r),
                    createBaseVNode("div", _hoisted_4$p, [
                      createBaseVNode("h6", null, toDisplayString(_ctx.userinfo.username), 1),
...
var index$q = /* @__PURE__ */ _export_sfc(_sfc_main$L, [["render", _sfc_render$L], ["__scopeId", "data-v-a960b686"]]);
...
const _sfc_main$K = {};
const _hoisted_1$H = /* @__PURE__ */ createBaseVNode("div", { class: "qrcode-container" }, [
...
var index$p = /* @__PURE__ */ _export_sfc(_sfc_main$K, [["render", _sfc_render$K]]);
...
const _hoisted_1$G = /* @__PURE__ */ createBaseVNode("p", null, "\u8FD9\u91CC\u662Fhttp\u7F51\u7EDC\u5F02\u6B65\u7EC4\u4EF6\uFF0C\u8BF7\u5148\u6253\u5F00\u670D\u52A1", -1);
...
var index$o = /* @__PURE__ */ _export_sfc(_sfc_main$J, [["render", _sfc_render$J]]);
...
const _hoisted_1$F = /* @__PURE__ */ createTextVNode("\u5355\u72EC\u6253\u5F00");
const _hoisted_2$v = /* @__PURE__ */ createTextVNode("\u8FD4\u56DE\u9996\u9875");
...
var error403 = /* @__PURE__ */ _export_sfc(_sfc_main$I, [["render", _sfc_render$I]]);
...
const _hoisted_1$E = /* @__PURE__ */ createTextVNode("\u8FD4\u56DE\u9996\u9875");
...
var error404 = /* @__PURE__ */ _export_sfc(_sfc_main$H, [["render", _sfc_render$H]]);
...
const _hoisted_1$D = /* @__PURE__ */ createTextVNode("\u5355\u72EC\u6253\u5F00");
const _hoisted_2$u = /* @__PURE__ */ createTextVNode("\u8FD4\u56DE\u9996\u9875");
...
var error500 = /* @__PURE__ */ _export_sfc(_sfc_main$G, [["render", _sfc_render$G]]);
...
const _hoisted_1$C = /* @__PURE__ */ createBaseVNode("span", null, "\u6210\u529F\u7ED3\u679C", -1);
const _hoisted_2$t = /* @__PURE__ */ createTextVNode("\u5173\u95ED\u9875\u9762");
const _hoisted_3$q = /* @__PURE__ */ createTextVNode("\u524D\u5F80\u5546\u5BB6");
const _hoisted_4$o = /* @__PURE__ */ createBaseVNode("span", null, "\u8B66\u544A\u64CD\u4F5C", -1);
const _hoisted_5$l = /* @__PURE__ */ createTextVNode("\u5173\u95ED\u9875\u9762");
const _hoisted_6$k = /* @__PURE__ */ createTextVNode(" \u524D\u5F80\u82F9\u679C ");
const _hoisted_7$j = /* @__PURE__ */ createBaseVNode("span", null, "\u7981\u6B62\u63D0\u4EA4", -1);
const _hoisted_8$h = /* @__PURE__ */ createTextVNode("\u5173\u95ED\u9875\u9762");
const _hoisted_9$g = /* @__PURE__ */ createTextVNode("\u91CD\u65B0\u63D0\u4EA4");
const _hoisted_10$e = { class: "desc" };
const _hoisted_11$6 = /* @__PURE__ */ createBaseVNode("p", { style: { "font-size": "16px" } }, [
  /* @__PURE__ */ createBaseVNode("strong", null, "\u60A8\u63D0\u4EA4\u5931\u8D25\uFF0C\u53EF\u80FD\u4E5F\u6709\u4EE5\u4E0B\u9519\u8BEF:")
], -1);
const _hoisted_12$6 = /* @__PURE__ */ createTextVNode(" \u60A8\u7684\u8D26\u53F7\u53EF\u80FD\u5DF2\u88AB\u51BB\u7ED3 ");
...
var index$n = /* @__PURE__ */ _export_sfc(_sfc_main$F, [["render", _sfc_render$F]]);
...
const _sfc_main$E = {};
const _withScopeId$a = (n) => (pushScopeId("data-v-1b9065aa"), n = n(), popScopeId(), n);
const _hoisted_1$B = { class: "title" };
const _hoisted_2$s = /* @__PURE__ */ _withScopeId$a(() => /* @__PURE__ */ createBaseVNode("span", null, "\u52A8\u6001", -1));
const _hoisted_3$p = /* @__PURE__ */ _withScopeId$a(() => /* @__PURE__ */ createBaseVNode("ul", null, [
...
var Dynamic = /* @__PURE__ */ _export_sfc(_sfc_main$E, [["render", _sfc_render$E], ["__scopeId", "data-v-1b9065aa"]]);
...
const _hoisted_1$A = /* @__PURE__ */ createBaseVNode("span", { class: "active" }, "\u6536\u76CA\u989D", -1);
const _hoisted_2$r = /* @__PURE__ */ createBaseVNode("span", null, "\u9500\u552E\u989D", -1);
const _hoisted_3$o = { class: "market-info" };
const _hoisted_4$n = {
  id: "container",
  ref: "mountNode"
};
  ...
  return openBlock(), createBlock(_component_yxs_card, null, {
    ...
    default: withCtx(() => [
      createBaseVNode("div", _hoisted_3$o, [
        createBaseVNode("div", _hoisted_4$n, null, 512)
      ])
    ]),
    _: 1
  });
}
var Returns = /* @__PURE__ */ _export_sfc(_sfc_main$D, [["render", _sfc_render$D]]);
...
const _hoisted_1$z = /* @__PURE__ */ createTextVNode("\u4FE1\u606F");
const _hoisted_2$q = { class: "project-info" };
const _hoisted_3$n = /* @__PURE__ */ createTextVNode("\u63D2\u4EF6\u5E93\u4FE1\u606F");
const _hoisted_4$m = { class: "down" };
const _hoisted_5$k = /* @__PURE__ */ createBaseVNode("p", { class: "hidden-xs" }, "\u5FEB\u5230\u7897\u91CC\u6765", -1);
const _hoisted_6$j = /* @__PURE__ */ createTextVNode("\u4F7F\u7528\u6587\u6863");
const _hoisted_7$i = /* @__PURE__ */ createTextVNode("GitHub");
const _hoisted_8$g = /* @__PURE__ */ createTextVNode("\u70B9\u51FB\u4E0B\u8F7D");
...
var ProjectInfo = /* @__PURE__ */ _export_sfc(_sfc_main$C, [["render", _sfc_render$C]]);
...
const _hoisted_1$y = /* @__PURE__ */ createTextVNode("\u76C8\u5229\u7387/\u5360\u6BD4");
const _hoisted_2$p = /* @__PURE__ */ createBaseVNode("div", { id: "dom1" }, null, -1);
...
var Ripple = /* @__PURE__ */ _export_sfc(_sfc_main$B, [["render", _sfc_render$B]]);
...
const _withScopeId$9 = (n) => (pushScopeId("data-v-19182736"), n = n(), popScopeId(), n);
const _hoisted_1$x = /* @__PURE__ */ createTextVNode("\u6B22\u8FCE\u60A8");
const _hoisted_2$o = { class: "welcome" };
const _hoisted_3$m = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ createBaseVNode("div", { class: "head" }, [
  /* @__PURE__ */ createBaseVNode("img", {
    src: _imports_0$1,
    alt: ""
  })
], -1));
const _hoisted_4$l = { class: "des" };
const _hoisted_5$j = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ createBaseVNode("p", null, "\u524D\u7AEF\u5DE5\u7A0B\u5E08 | \u54C1\u8317\u80A1\u4EFD\uFF0Cvue-vite-admin-ts\uFF0C\u91C7\u7528Vite2.0\u3001Vue3.2\u3001TypeScript\u3001JavaScript\u6784\u5EFA\uFF0C\u652F\u6301\u591A\u79CD\u5199\u6CD5\u548C\u8C03\u7528\uFF0C\u5B8C\u6574\u7684\u6846\u67B6\u4F53\u7CFB\uFF0C\u9002\u5408\u4F01\u4E1A\u4E2D\u540E\u53F0\u54CD\u5E94\u5F0F\u7BA1\u7406\u7CFB\u7EDF\uFF0C\u652F\u6301\u73B0\u6709\u4E1A\u52A1\u5404\u79CD\u6269\u5C55....", -1));
const _hoisted_6$i = { class: "money" };
const _hoisted_7$h = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ createBaseVNode("div", { class: "money-header" }, [
  /* @__PURE__ */ createBaseVNode("span", { class: "label" }, "2021\u5168\u56FD\u9500\u552E\u989D"),
  /* @__PURE__ */ createBaseVNode("span", { class: "value" }, "\uFFE515920.00")
], -1));
const _hoisted_8$f = { class: "money-content" };
const _hoisted_9$f = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ createBaseVNode("span", null, "7\u6708\u540C\u6BD4", -1));
const _hoisted_10$d = { class: "rise" };
const _hoisted_11$5 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ createBaseVNode("span", null, "+8%", -1));
const _hoisted_12$5 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ createBaseVNode("span", null, "8\u6708\u540C\u6BD4", -1));
const _hoisted_13$4 = { class: "fall" };
const _hoisted_14$4 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ createBaseVNode("span", null, "-6%", -1));
const _hoisted_15$4 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ createBaseVNode("div", { class: "money-footer" }, [
...
const _hoisted_17$2 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ createBaseVNode("div", { class: "money-header" }, [
...
const _hoisted_19$2 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ createBaseVNode("span", null, "7\u6708\u540C\u6BD4", -1));
const _hoisted_20$2 = { class: "rise" };
const _hoisted_21$2 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ createBaseVNode("span", null, "+8%", -1));
const _hoisted_22$1 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ createBaseVNode("span", null, "8\u6708\u540C\u6BD4", -1));
const _hoisted_23$1 = { class: "fall" };
const _hoisted_24$1 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ createBaseVNode("span", null, "-6%", -1));
const _hoisted_25$1 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ createBaseVNode("div", { class: "money-footer" }, [
...
const _hoisted_27$1 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ createBaseVNode("div", { class: "money-header" }, [
  /* @__PURE__ */ createBaseVNode("span", { class: "label" }, "\u603B\u9500\u552E\u989D"),
  /* @__PURE__ */ createBaseVNode("span", { class: "value" }, "\uFFE515920")
], -1));
const _hoisted_28$1 = { class: "money-content" };
const _hoisted_29$1 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ createBaseVNode("span", null, "7\u6708\u540C\u6BD4", -1));
const _hoisted_30$1 = { class: "rise" };
const _hoisted_31$1 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ createBaseVNode("span", null, "+8%", -1));
const _hoisted_32$1 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ createBaseVNode("span", null, "8\u6708\u540C\u6BD4", -1));
const _hoisted_33$1 = { class: "fall" };
const _hoisted_34$1 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ createBaseVNode("span", null, "-6%", -1));
const _hoisted_35$1 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ createBaseVNode("div", { class: "money-footer" }, [
  /* @__PURE__ */ createBaseVNode("span", { class: "label" }, "\u65E5\u9500\u552E\u989D"),
  /* @__PURE__ */ createBaseVNode("span", { class: "value" }, "\uFFE51298.00")
], -1));
const _hoisted_36$1 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ createBaseVNode("div", { class: "profit-header" }, [
...
const _hoisted_37 = /* @__PURE__ */ _withScopeId$9(() => /* @__PURE__ */ createBaseVNode("div", { class: "profit-content" }, [
...
var index$m = /* @__PURE__ */ _export_sfc(_sfc_main$A, [["render", _sfc_render$A], ["__scopeId", "data-v-19182736"]]);
...
const _withScopeId$8 = (n) => (pushScopeId("data-v-7dc48820"), n = n(), popScopeId(), n);
const _hoisted_1$w = { class: "login" };
const _hoisted_2$n = { class: "login-container" };
const _hoisted_3$l = { class: "login-content" };
const _hoisted_4$k = /* @__PURE__ */ _withScopeId$8(() => /* @__PURE__ */ createBaseVNode("div", { class: "slide-left" }, [
  /* @__PURE__ */ createBaseVNode("img", {
    src: _imports_0,
    alt: ""
  })
], -1));
const _hoisted_5$i = { class: "slide-right" };
const _hoisted_6$h = /* @__PURE__ */ _withScopeId$8(() => /* @__PURE__ */ createBaseVNode("h2", null, "\u6B22\u8FCE\u60A8\u767B\u5F55", -1));
const _hoisted_7$g = /* @__PURE__ */ _withScopeId$8(() => /* @__PURE__ */ createBaseVNode("p", null, "\u4F60\u53EF\u4EE5\u76F4\u63A5\u8F93\u5165\u60A8\u7684\u8D26\u53F7\u548C\u5BC6\u7801\u767B\u5F55", -1));
const _hoisted_8$e = { class: "login-options" };
const _hoisted_9$e = /* @__PURE__ */ createTextVNode("\u4E03\u5929\u8BB0\u4F4F\u6211");
const _hoisted_10$c = /* @__PURE__ */ _withScopeId$8(() => /* @__PURE__ */ createBaseVNode("span", { class: "hover-text-underline" }, "\u5FD8\u8BB0\u5BC6\u7801? \u627E\u56DE\u5BC6\u7801", -1));
const _hoisted_11$4 = { class: "login-btn" };
const _hoisted_12$4 = /* @__PURE__ */ _withScopeId$8(() => /* @__PURE__ */ createBaseVNode("p", { style: { "text-align": "center" } }, "\u6CA1\u6709\u8D26\u53F7? \u6CE8\u518C\u8D26\u53F7", -1));
const _hoisted_13$3 = /* @__PURE__ */ _withScopeId$8(() => /* @__PURE__ */ createBaseVNode("img", {
  class: "embe embe1",
  src: _imports_1,
  alt: ""
}, null, -1));
const _hoisted_14$3 = /* @__PURE__ */ _withScopeId$8(() => /* @__PURE__ */ createBaseVNode("img", {
  class: "embe embe2 hidden-xs",
  src: _imports_1,
  alt: ""
}, null, -1));
const _hoisted_15$3 = /* @__PURE__ */ _withScopeId$8(() => /* @__PURE__ */ createBaseVNode("img", {
...
var index$l = /* @__PURE__ */ _export_sfc(_sfc_main$z, [["render", _sfc_render$z], ["__scopeId", "data-v-7dc48820"]]);
...
const _sfc_main$y = defineComponent({
  ...
  setup() {
    ...
    watch([radioValue], () => {
      visible.value = false;
      apiUserinfo({ type: radioValue.value }).then((res) => {
        store2.commit("user/updateUserinfo", res);
        visible.value = true;
      });
    });
...
const _hoisted_1$v = /* @__PURE__ */ createTextVNode("\u8D26\u53F7\u5207\u6362");
const _hoisted_2$m = /* @__PURE__ */ createTextVNode("\u7BA1\u7406\u5458");
const _hoisted_3$k = /* @__PURE__ */ createTextVNode("\u6D4B\u8BD5\u4EBA\u5458");
const _hoisted_4$j = /* @__PURE__ */ createTextVNode("\u5BA2\u6237\u4F7F\u7528\u4EBA\u5458");
const _hoisted_5$h = /* @__PURE__ */ createTextVNode("\u53EF\u7F16\u8F91\u4EBA\u5458");
const _hoisted_6$g = /* @__PURE__ */ createBaseVNode("br", null, null, -1);
const _hoisted_7$f = /* @__PURE__ */ createBaseVNode("br", null, null, -1);
const _hoisted_8$d = /* @__PURE__ */ createTextVNode("\u63CF\u8FF0");
const _hoisted_9$d = /* @__PURE__ */ createTextVNode("\u5F53\u524D\u7528\u6237\u7684\u89D2\u8272\u6743\u9650 ");
const _hoisted_10$b = /* @__PURE__ */ createBaseVNode("br", null, null, -1);
const _hoisted_11$3 = /* @__PURE__ */ createTextVNode("admin\u7BA1\u7406\u5458\u6743\u9650");
const _hoisted_12$3 = /* @__PURE__ */ createTextVNode("test\u6D4B\u8BD5\u4EBA\u5458\u6743\u9650");
...
var index$k = /* @__PURE__ */ _export_sfc(_sfc_main$y, [["render", _sfc_render$y]]);
...
const _hoisted_1$u = { class: "add" };
const _hoisted_2$l = /* @__PURE__ */ createTextVNode("\u663E\u793A");
const _hoisted_3$j = /* @__PURE__ */ createTextVNode("\u9690\u85CF");
const _hoisted_4$i = /* @__PURE__ */ createTextVNode("\u662F");
const _hoisted_5$g = /* @__PURE__ */ createTextVNode("\u5426");
const _hoisted_6$f = /* @__PURE__ */ createTextVNode("\u663E\u793A");
const _hoisted_7$e = /* @__PURE__ */ createTextVNode("\u9690\u85CF");
const _hoisted_8$c = { class: "item-icons" };
const _hoisted_9$c = { class: "item-icon" };
function _sfc_render$x(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock(Fragment, null, [
                  ...
                  createVNode(_component_a_form_item, {
                    ...
                    default: withCtx(() => [
                      createVNode(_component_a_select, {
                        value: _ctx.formState.limits,
                        "onUpdate:value": _cache[9] || (_cache[9] = ($event) => _ctx.formState.limits = $event),
                        mode: "multiple",
                        style: { "width": "100%" },
                        placeholder: "\u9009\u62E9\u7528\u6237\u6743\u9650",
                  ...
                  createVNode(_component_a_form_item, {
                    ...
                    default: withCtx(() => [
                      createVNode(_component_a_switch, {
                        ...
                        "onUpdate:checked": _cache[10] || (_cache[10] = ($event) => _ctx.formState.keepAlive = $event)
                      }, null, 8, ["checked"])
                    ]),
                    _: 1
                  })
                  ...
                  createVNode(_component_a_form_item, {
                    ...
                    default: withCtx(() => [
                      createVNode(_component_a_radio_group, {
                        ...
                        "onUpdate:value": _cache[11] || (_cache[11] = ($event) => _ctx.formState.tabHidden = $event)
                      }, {
                        default: withCtx(() => [
                  ...
                  createVNode(_component_a_form_item, {
                    ...
                    default: withCtx(() => [
                      createVNode(_component_a_radio_group, {
                        ...
                        "onUpdate:value": _cache[12] || (_cache[12] = ($event) => _ctx.formState.tabFix = $event)
                      }, {
                        default: withCtx(() => [
                          createVNode(_component_a_radio, { value: 1 }, {
                            default: withCtx(() => [
                  ...
                  createVNode(_component_a_form_item, {
                    ...
                    default: withCtx(() => [
                      createVNode(_component_a_radio_group, {
                        ...
                        "onUpdate:value": _cache[13] || (_cache[13] = ($event) => _ctx.formState.shows = $event)
                      }, {
                        default: withCtx(() => [
                          createVNode(_component_a_radio, { value: 1 }, {
                            default: withCtx(() => [
    ...
    createVNode(_component_a_modal, {
      ...
      "onUpdate:visible": _cache[14] || (_cache[14] = ($event) => _ctx.visible = $event),
      width: "1000px",
      title: "\u9009\u62E9icon",
      onOk: _ctx.handleOk,
      okText: "\u786E\u8BA4",
...
var add = /* @__PURE__ */ _export_sfc(_sfc_main$x, [["render", _sfc_render$x], ["__scopeId", "data-v-1427f8f4"]]);
...
const _sfc_main$w = defineComponent({
  ...
  setup(props2, { emit }) {
    ...
    const getMenuData = () => {
      apiFindOne({ id: props2.id }).then((res) => {
...
const _hoisted_1$t = { class: "add" };
const _hoisted_2$k = /* @__PURE__ */ createTextVNode("\u663E\u793A");
const _hoisted_3$i = /* @__PURE__ */ createTextVNode("\u9690\u85CF");
const _hoisted_4$h = /* @__PURE__ */ createTextVNode("\u662F");
const _hoisted_5$f = /* @__PURE__ */ createTextVNode("\u5426");
const _hoisted_6$e = /* @__PURE__ */ createTextVNode("\u663E\u793A");
const _hoisted_7$d = /* @__PURE__ */ createTextVNode("\u9690\u85CF");
const _hoisted_8$b = { class: "item-icons" };
const _hoisted_9$b = { class: "item-icon" };
...
var edit = /* @__PURE__ */ _export_sfc(_sfc_main$w, [["render", _sfc_render$w], ["__scopeId", "data-v-6ab4f3af"]]);
...
const _hoisted_1$s = { class: "table-action" };
const _hoisted_2$j = { class: "table-action-btn" };
const _hoisted_3$h = /* @__PURE__ */ createTextVNode("\u5237\u65B0");
const _hoisted_4$g = /* @__PURE__ */ createTextVNode("\u65B0\u589E ");
const _hoisted_5$e = /* @__PURE__ */ createTextVNode("\u5220\u9664");
const _hoisted_6$d = { class: "table-action-search hidden-xs" };
const _hoisted_7$c = /* @__PURE__ */ createTextVNode("\u76EE\u5F55");
const _hoisted_8$a = /* @__PURE__ */ createTextVNode("\u83DC\u5355");
const _hoisted_9$a = /* @__PURE__ */ createTextVNode("\u7F16\u8F91");
const _hoisted_10$a = /* @__PURE__ */ createTextVNode("\u5220\u9664");
            ...
            createVNode(_component_a_space, { size: 20 }, {
              default: withCtx(() => [
                ...
                createVNode(_component_a_button, {
                  ...
                  size: "middle",
                  onClick: _cache[0] || (_cache[0] = ($event) => (_ctx.visibleAdd = true, _ctx.activeKey = "1"))
                }, {
                  default: withCtx(() => [
                    _hoisted_4$g
                  ]),
...
var menu = /* @__PURE__ */ _export_sfc(_sfc_main$v, [["render", _sfc_render$v], ["__scopeId", "data-v-59d64c0b"]]);
...
var index$j = /* @__PURE__ */ _export_sfc(_sfc_main$u, [["render", _sfc_render$u]]);
...
const _withScopeId$7 = (n) => (pushScopeId("data-v-59e04732"), n = n(), popScopeId(), n);
const _hoisted_1$r = /* @__PURE__ */ _withScopeId$7(() => /* @__PURE__ */ createBaseVNode("div", { class: "item" }, [
  /* @__PURE__ */ createBaseVNode("div", { id: "circle1" })
], -1));
const _hoisted_2$i = /* @__PURE__ */ _withScopeId$7(() => /* @__PURE__ */ createBaseVNode("div", { class: "item" }, [
  /* @__PURE__ */ createBaseVNode("div", { id: "circle2" })
], -1));
const _hoisted_3$g = /* @__PURE__ */ _withScopeId$7(() => /* @__PURE__ */ createBaseVNode("div", { class: "item" }, [
  /* @__PURE__ */ createBaseVNode("div", { id: "circle3" })
], -1));
const _hoisted_4$f = /* @__PURE__ */ _withScopeId$7(() => /* @__PURE__ */ createBaseVNode("div", { class: "item" }, [
  /* @__PURE__ */ createBaseVNode("div", {
    id: "ease_in",
    class: "example"
  })
], -1));
const _hoisted_5$d = /* @__PURE__ */ _withScopeId$7(() => /* @__PURE__ */ createBaseVNode("div", { class: "item" }, [
  /* @__PURE__ */ createBaseVNode("div", {
    id: "ease_out",
    class: "example"
  })
], -1));
const _hoisted_6$c = /* @__PURE__ */ _withScopeId$7(() => /* @__PURE__ */ createBaseVNode("div", { class: "item" }, [
  /* @__PURE__ */ createBaseVNode("div", {
    id: "ease_inout",
    class: "example"
  })
], -1));
const _hoisted_7$b = /* @__PURE__ */ _withScopeId$7(() => /* @__PURE__ */ createBaseVNode("div", { class: "item" }, [
  /* @__PURE__ */ createBaseVNode("div", {
    id: "bounce_in",
    class: "example"
  })
], -1));
const _hoisted_8$9 = /* @__PURE__ */ _withScopeId$7(() => /* @__PURE__ */ createBaseVNode("div", { class: "item" }, [
  /* @__PURE__ */ createBaseVNode("div", {
    id: "bounce_out",
    class: "example"
  })
], -1));
const _hoisted_9$9 = /* @__PURE__ */ _withScopeId$7(() => /* @__PURE__ */ createBaseVNode("div", { class: "item" }, [
  /* @__PURE__ */ createBaseVNode("div", {
    id: "bounce_inout",
    class: "example"
  })
], -1));
const _hoisted_10$9 = /* @__PURE__ */ _withScopeId$7(() => /* @__PURE__ */ createBaseVNode("div", { class: "item" }, [
  /* @__PURE__ */ createBaseVNode("div", {
    id: "js-el",
    class: "el"
  })
...
var index$i = /* @__PURE__ */ _export_sfc(_sfc_main$t, [["render", _sfc_render$t], ["__scopeId", "data-v-59e04732"]]);
...
function _sfc_render$s(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$q, null, 512);
}
var demo1 = /* @__PURE__ */ _export_sfc(_sfc_main$s, [["render", _sfc_render$s]]);
...
const _hoisted_2$h = /* @__PURE__ */ createTextVNode("\u67E5\u770B\u5B98\u65B9[\u66F4\u591A\u53C3\u8003\u4F8B\u5B50]");
...
var demo2 = /* @__PURE__ */ _export_sfc(_sfc_main$r, [["render", _sfc_render$r], ["__scopeId", "data-v-ff124970"]]);
...
var demo3 = /* @__PURE__ */ _export_sfc(_sfc_main$q, [["render", _sfc_render$q]]);
...
var demo4 = /* @__PURE__ */ _export_sfc(_sfc_main$p, [["render", _sfc_render$p]]);
...
function _sfc_render$o(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$m, null, 512);
}
var demo5 = /* @__PURE__ */ _export_sfc(_sfc_main$o, [["render", _sfc_render$o]]);
...
function _sfc_render$n(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$l, null, 512);
}
var demo6 = /* @__PURE__ */ _export_sfc(_sfc_main$n, [["render", _sfc_render$n]]);
...
const _withScopeId$6 = (n) => (pushScopeId("data-v-4d1b60b6"), n = n(), popScopeId(), n);
const _hoisted_1$k = /* @__PURE__ */ _withScopeId$6(() => /* @__PURE__ */ createBaseVNode("h1", null, "ECharts \u7B80\u4ECB", -1));
const _hoisted_2$g = /* @__PURE__ */ _withScopeId$6(() => /* @__PURE__ */ createBaseVNode("p", null, "ECharts\u5B83\u662F\u4E00\u4E2A\u7EAFJavaScript\u7684\u56FE\u6807\u5E93\uFF0C\u517C\u5BB9\u7EDD\u5927\u90E8\u5206\u7684\u6D4F\u89C8\u5668\uFF0C\u5E95\u5C42\u4F9D\u8D56\u8F7B\u91CF\u7EA7\u7684canvas\u7C7B\u5E93ZRender\uFF0C\u63D0\u4F9B\u76F4\u89C2\uFF0C\u751F\u52A8\uFF0C\u53EF\u4EA4\u4E92\uFF0C\u53EF\u9AD8\u5EA6\u4E2A\u6027\u5316\u5B9A\u5236\u7684\u6570\u636E\u53EF\u89C6\u5316\u56FE\u8868\u3002\u521B\u65B0\u7684\u62D6\u62FD\u91CD\u8BA1\u7B97\u3001\u6570\u636E\u89C6\u56FE\u3001\u503C\u57DF\u6F2B\u6E38\u7B49\u7279\u6027\u5927\u5927\u589E\u5F3A\u4E86\u7528\u6237\u4F53\u9A8C\uFF0C\u8D4B\u4E88\u4E86\u7528\u6237\u5BF9\u6570\u636E\u8FDB\u884C\u6316\u6398\u3001\u6574\u5408\u7684\u80FD\u529B", -1));
const _hoisted_3$f = /* @__PURE__ */ _withScopeId$6(() => /* @__PURE__ */ createBaseVNode("br", null, null, -1));
const _hoisted_4$e = /* @__PURE__ */ _withScopeId$6(() => /* @__PURE__ */ createBaseVNode("h1", null, "\u6570\u636E\u96C6", -1));
const _hoisted_5$c = /* @__PURE__ */ _withScopeId$6(() => /* @__PURE__ */ createBaseVNode("p", null, "\u{1F4CA}ECharts 5 \u52A0\u5F3A\u4E86\u6570\u636E\u96C6\u7684\u6570\u636E\u8F6C\u6362\u80FD\u529B\uFF0C\u8BA9\u5F00\u53D1\u8005\u53EF\u4EE5\u4F7F\u7528\u7B80\u5355\u7684\u65B9\u5F0F\u5B9E\u73B0\u5E38\u7528\u7684\u6570\u636E\u5904\u7406\uFF0C\u5982\uFF1A\u6570\u636E\u8FC7\u6EE4\uFF08filter\uFF09\u3001\u6392\u5E8F\uFF08sort\uFF09\u3001\u805A\u5408\uFF08aggregate\uFF09\u3001\u76F4\u65B9\u56FE\uFF08histogram\uFF09\u3001\u7B80\u5355\u805A\u7C7B\uFF08clustering\uFF09\u3001\u56DE\u5F52\u7EBF\u8BA1\u7B97\uFF08regression\uFF09\u7B49\u3002\u5F00\u53D1\u8005\u53EF\u4EE5\u7528\u7EDF\u4E00\u7684\u58F0\u660E\u5F0F\u65B9\u5F0F\u6765\u4F7F\u7528\u8FD9\u4E9B\u529F\u80FD\uFF0C\u53EF\u4EE5\u65B9\u4FBF\u5730\u5B9E\u73B0\u5E38\u7528\u7684\u6570\u636E\u64CD\u4F5C", -1));
const _hoisted_6$b = /* @__PURE__ */ _withScopeId$6(() => /* @__PURE__ */ createBaseVNode("br", null, null, -1));
const _hoisted_7$a = /* @__PURE__ */ _withScopeId$6(() => /* @__PURE__ */ createBaseVNode("h1", null, "TypeScript \u91CD\u6784", -1));
const _hoisted_8$8 = /* @__PURE__ */ _withScopeId$6(() => /* @__PURE__ */ createBaseVNode("p", null, "\u{1F98D} \u5728\u8FD1 8 \u5E74\u7684\u65F6\u95F4\u91CC\uFF0CApache ECharts \u5DF2\u7ECF\u53D1\u5C55\u6210\u4E00\u4E2A\u975E\u5E38\u590D\u6742\u7684\u53EF\u89C6\u5316\u5E93\u4E86\uFF0C\u4E3A\u4E86\u53EF\u4EE5\u66F4\u5B89\u5168\u9AD8\u6548\u7684\u8FDB\u884C\u91CD\u6784\u548C\u65B0\u529F\u80FD\u7684\u5F00\u53D1\uFF0C\u6211\u4EEC\u5728 Apache ECharts 5 \u7684\u5F00\u53D1\u4E4B\u521D\uFF0C\u4F7F\u7528 TypeScript \u5BF9\u4EE3\u7801\u8FDB\u884C\u4E86\u91CD\u5199\uFF0CTypeScript \u6240\u5E26\u6765\u7684\u5F3A\u7C7B\u578B\u8BA9\u6211\u4EEC\u66F4\u6709\u4FE1\u5FC3\u5730\u5728 ECharts 5 \u5F00\u53D1\u7684\u65F6\u5019\u5BF9\u4EE3\u7801\u8FDB\u884C\u5927\u5200\u9614\u65A7\u7684\u91CD\u6784\u4EE5\u5B9E\u73B0\u66F4\u591A\u4EE4\u4EBA\u6FC0\u52A8\u4EBA\u5FC3\u7684\u7279\u6027", -1));
const _hoisted_9$8 = /* @__PURE__ */ _withScopeId$6(() => /* @__PURE__ */ createBaseVNode("br", null, null, -1));
const _hoisted_10$8 = /* @__PURE__ */ _withScopeId$6(() => /* @__PURE__ */ createBaseVNode("br", null, null, -1));
const _hoisted_11$2 = { class: "item" };
...
var index$h = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["render", _sfc_render$m], ["__scopeId", "data-v-4d1b60b6"]]);
...
const _withScopeId$5 = (n) => (pushScopeId("data-v-21d4f34a"), n = n(), popScopeId(), n);
const _hoisted_1$j = /* @__PURE__ */ _withScopeId$5(() => /* @__PURE__ */ createBaseVNode("h1", null, "G2 \u7B80\u4ECB", -1));
const _hoisted_2$f = /* @__PURE__ */ _withScopeId$5(() => /* @__PURE__ */ createBaseVNode("p", null, "G2 \u662F\u4E00\u5957\u57FA\u4E8E\u56FE\u5F62\u8BED\u6CD5\u7406\u8BBA\u7684\u53EF\u89C6\u5316\u5E95\u5C42\u5F15\u64CE\uFF0C\u4EE5\u6570\u636E\u9A71\u52A8\uFF0C\u63D0\u4F9B\u56FE\u5F62\u8BED\u6CD5\u4E0E\u4EA4\u4E92\u8BED\u6CD5\uFF0C\u5177\u6709\u9AD8\u5EA6\u7684\u6613\u7528\u6027\u548C\u6269\u5C55\u6027\u3002\u4F7F\u7528 G2\uFF0C\u4F60\u53EF\u4EE5\u65E0\u9700\u5173\u6CE8\u56FE\u8868\u5404\u79CD\u7E41\u7410\u7684\u5B9E\u73B0\u7EC6\u8282\uFF0C\u4E00\u6761\u8BED\u53E5\u5373\u53EF\u4F7F\u7528 Canvas \u6216 SVG \u6784\u5EFA\u51FA\u5404\u79CD\u5404\u6837\u7684\u53EF\u4EA4\u4E92\u7684\u7EDF\u8BA1\u56FE\u8868", -1));
const _hoisted_3$e = /* @__PURE__ */ _withScopeId$5(() => /* @__PURE__ */ createBaseVNode("br", null, null, -1));
const _hoisted_4$d = /* @__PURE__ */ _withScopeId$5(() => /* @__PURE__ */ createBaseVNode("h1", null, "\u2728 \u7279\u6027", -1));
const _hoisted_5$b = /* @__PURE__ */ _withScopeId$5(() => /* @__PURE__ */ createBaseVNode("p", null, "\u{1F4AF} \u5B8C\u5584\u7684\u56FE\u5F62\u8BED\u6CD5\uFF1A\u6570\u636E\u5230\u56FE\u5F62\u7684\u6620\u5C04\uFF0C\u80FD\u591F\u7ED8\u5236\u51FA\u6240\u6709\u7684\u56FE\u8868\u3002", -1));
const _hoisted_6$a = /* @__PURE__ */ _withScopeId$5(() => /* @__PURE__ */ createBaseVNode("p", null, "\u{1F929} \u5168\u65B0\u7684\u4EA4\u4E92\u8BED\u6CD5\uFF1A\u901A\u8FC7\u89E6\u53D1\u548C\u53CD\u9988\u673A\u5236\u53EF\u4EE5\u7EC4\u5408\u51FA\u5404\u79CD\u4EA4\u4E92\u884C\u4E3A\uFF0C\u5BF9\u6570\u636E\u8FDB\u884C\u63A2\u7D22\u3002", -1));
const _hoisted_7$9 = /* @__PURE__ */ _withScopeId$5(() => /* @__PURE__ */ createBaseVNode("p", null, "\u{1F98D} \u5F3A\u5927\u7684 View \u6A21\u5757\uFF1A\u53EF\u652F\u6301\u5F00\u53D1\u4E2A\u6027\u5316\u7684\u6570\u636E\u591A\u7EF4\u5206\u6790\u56FE\u5F62\u3002", -1));
const _hoisted_8$7 = /* @__PURE__ */ _withScopeId$5(() => /* @__PURE__ */ createBaseVNode("p", null, "\u{1F46C} \u53CC\u5F15\u64CE\u6E32\u67D3\uFF1ACanvas \u6216 SVG \u4EFB\u610F\u5207\u6362\u3002", -1));
const _hoisted_9$7 = /* @__PURE__ */ _withScopeId$5(() => /* @__PURE__ */ createBaseVNode("p", null, "\u{1F484} \u53EF\u89C6\u5316\u7EC4\u4EF6\u4F53\u7CFB\uFF1A\u9762\u5411\u4EA4\u4E92\u3001\u4F53\u9A8C\u4F18\u96C5\u3002", -1));
const _hoisted_10$7 = /* @__PURE__ */ _withScopeId$5(() => /* @__PURE__ */ createBaseVNode("p", null, "\u{1F6E1} \u5168\u9762\u62E5\u62B1 TypeScript\uFF1A\u63D0\u4F9B\u5B8C\u6574\u7684\u7C7B\u578B\u5B9A\u4E49\u6587\u4EF6\u3002", -1));
const _hoisted_11$1 = /* @__PURE__ */ _withScopeId$5(() => /* @__PURE__ */ createBaseVNode("br", null, null, -1));
const _hoisted_12$1 = /* @__PURE__ */ createTextVNode("\u67E5\u770B\u5B98\u65B9[\u66F4\u591A\u53C3\u8003\u4F8B\u5B50]");
function _sfc_render$l(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_a_typography_link = resolveComponent("a-typography-link");
  const _component_yxs_view = resolveComponent("yxs-view");
  return openBlock(), createBlock(_component_yxs_view, null, {
...
var index$g = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["render", _sfc_render$l], ["__scopeId", "data-v-21d4f34a"]]);
...
const _withScopeId$4 = (n) => (pushScopeId("data-v-31069ab9"), n = n(), popScopeId(), n);
const _hoisted_1$i = /* @__PURE__ */ _withScopeId$4(() => /* @__PURE__ */ createBaseVNode("h1", null, "\u7B80\u4ECB", -1));
const _hoisted_2$e = /* @__PURE__ */ _withScopeId$4(() => /* @__PURE__ */ createBaseVNode("p", null, 'G2Plot \u662F\u4E00\u5957\u7B80\u5355\u3001\u6613\u7528\u3001\u5E76\u5177\u5907\u4E00\u5B9A\u6269\u5C55\u80FD\u529B\u548C\u7EC4\u5408\u80FD\u529B\u7684\u7EDF\u8BA1\u56FE\u8868\u5E93\uFF0C\u57FA\u4E8E\u56FE\u5F62\u8BED\u6CD5\u7406\u8BBA\u642D\u5EFA\u800C\u6210\uFF0C"G2Plot"\u4E2D\u7684 G2 \u5373\u610F\u6307\u56FE\u5F62\u8BED\u6CD5 (the Gramma of Graphics)\uFF0C\u540C\u65F6\u4E5F\u81F4\u656C\u4E86 ggplot2\u3002', -1));
const _hoisted_3$d = /* @__PURE__ */ _withScopeId$4(() => /* @__PURE__ */ createBaseVNode("br", null, null, -1));
const _hoisted_4$c = /* @__PURE__ */ _withScopeId$4(() => /* @__PURE__ */ createBaseVNode("h1", null, "\u7279\u6027", -1));
const _hoisted_5$a = /* @__PURE__ */ _withScopeId$4(() => /* @__PURE__ */ createBaseVNode("p", null, "\u{1F4E6} \u5F00\u7BB1\u5373\u7528\u3001\u9ED8\u8BA4\u597D\u7528\u7684\u9AD8\u8D28\u91CF\u7EDF\u8BA1\u56FE\u8868", -1));
const _hoisted_6$9 = /* @__PURE__ */ _withScopeId$4(() => /* @__PURE__ */ createBaseVNode("p", null, " \u{1F3A8} \u63D0\u70BC\u81EA\u4F01\u4E1A\u7EA7\u4EA7\u54C1\u7684\u89C6\u89C9\u8BED\u8A00\u548C\u8BBE\u8BA1\u89C4\u8303", -1));
const _hoisted_7$8 = /* @__PURE__ */ _withScopeId$4(() => /* @__PURE__ */ createBaseVNode("p", null, "\u{1F4CA} \u54CD\u5E94\u5F0F\u56FE\u8868\uFF1A\u81F4\u529B\u4E8E\u89E3\u51B3\u56FE\u8868\u5728\u4EFB\u4F55\u6570\u636E\u548C\u663E\u793A\u5C3A\u5BF8\u4E0B\u7684\u57FA\u672C\u53EF\u8BFB\u6027\u95EE\u9898", -1));
const _hoisted_8$6 = /* @__PURE__ */ _withScopeId$4(() => /* @__PURE__ */ createBaseVNode("p", null, "\u{1F533} \u56FE\u5C42\u5316\u8BBE\u8BA1\u65B9\u6CD5\uFF1A\u5728 G2Plot \u4F53\u7CFB\u4E0B\uFF0C\u56FE\u8868\u4E0D\u4EC5\u4EC5\u53EA\u662F\u5404\u4E0D\u76F8\u5173\u7684\u5B9E\u4F8B\uFF0C\u56FE\u5C42\u6982\u5FF5\u7684\u5F15\u5165\u63D0\u4F9B\u4E86\u591A\u56FE\u8868\u7EC4\u5408\u53E0\u8054\u52A8\uFF0C\u5171\u540C\u8BB2\u8FF0\u4E00\u4E2A\u6570\u636E\u6545\u4E8B\u7684\u53EF\u80FD\u6027", -1));
const _hoisted_9$6 = /* @__PURE__ */ _withScopeId$4(() => /* @__PURE__ */ createBaseVNode("br", null, null, -1));
const _hoisted_10$6 = /* @__PURE__ */ createTextVNode("\u67E5\u770B\u5B98\u65B9[\u66F4\u591A\u53C3\u8003\u4F8B\u5B50]");
...
var index$f = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["render", _sfc_render$k], ["__scopeId", "data-v-31069ab9"]]);
...
const _hoisted_1$h = /* @__PURE__ */ createTextVNode("Vue3\u5F02\u5E38\u6355\u83B7");
const _hoisted_2$d = /* @__PURE__ */ createTextVNode(" \u5B98\u65B9\u63A8\u8350\u53EF\u4EE5\u4F7F\u7528\u9519\u8BEF\u8FFD\u8E2A\u670D\u52A1 ");
const _hoisted_3$c = /* @__PURE__ */ createBaseVNode("a", {
  href: "https://sentry.io/for/vue/",
  target: "_blank"
}, "Sentry", -1);
const _hoisted_4$b = /* @__PURE__ */ createTextVNode("\u548C ");
const _hoisted_5$9 = /* @__PURE__ */ createBaseVNode("a", {
  target: "_blank",
  href: "https://docs.bugsnag.com/platforms/javascript/vue/"
}, "Bugsnag ", -1);
const _hoisted_6$8 = /* @__PURE__ */ createTextVNode("\u4F7F\u7528\u6B64\u9009\u9879\u63D0\u4F9B\u5B98\u65B9\u96C6\u6210 ");
function _sfc_render$j(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_a_table = resolveComponent("a-table");
  const _component_yxs_view = resolveComponent("yxs-view");
  return openBlock(), createBlock(_component_yxs_view, null, {
...
var index$e = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["render", _sfc_render$j]]);
...
const _hoisted_1$g = /* @__PURE__ */ createTextVNode("\u7F16\u8F91");
const _hoisted_2$c = /* @__PURE__ */ createTextVNode("iPhone 13 Pro");
const _hoisted_3$b = /* @__PURE__ */ createTextVNode("\u82F9\u679C\u5B98\u65B9");
const _hoisted_4$a = /* @__PURE__ */ createTextVNode("2021\u5E7410\u67081\u65E5 18:00:00");
const _hoisted_5$8 = /* @__PURE__ */ createTextVNode("1.00");
const _hoisted_6$7 = /* @__PURE__ */ createTextVNode("$8299.00");
const _hoisted_7$7 = /* @__PURE__ */ createTextVNode("$8900.00");
const _hoisted_8$5 = /* @__PURE__ */ createTextVNode(" \u8D85\u5148\u8FDB\u53CC\u6444\u7CFB\u7EDF\uFF0C\u7CBE\u8FDB\u518D\u7CBE\u8FDB\uFF0C\u8D85\u5F3A\u8010\u7528\u6027\uFF0C\u8FB9\u8FB9\u89D2\u89D2\u9762\u9762\u4FF1\u5230\uFF0C \u8D85\u9AD8\u901F\u82AF\u7247\uFF0C\u53C8\u4E00\u6B21\u8D85\u8D8A\u81EA\u6211\uFF0C\u8D85\u52B2\u7EED\u822A\u5927\u63D0\u5347\uFF0C\u6BCF\u5929\u4E00\u8DEF\u633A\u4F60\uFF0C\u8D85\u74F7\u6676\u9762\u677F\uFF0C\u51ED\u786C\u5B9E\u529B\u8BA9\u73BB\u7483\u9762\u677F\u670D\u8F6F\uFF0C\u8010\u7528\u7684 \u5E73\u76F4\u8FB9\u7F18 \u8BBE\u8BA1 ");
const _hoisted_9$5 = /* @__PURE__ */ createBaseVNode("br", null, null, -1);
const _hoisted_10$5 = /* @__PURE__ */ createTextVNode(" \u5168\u65B0\u8D85\u5E7F\u89D2\u6444\u50CF\u5934\uFF0C\u8BA9\u7167\u7247\u6697\u90E8\u8868\u73B0\u66F4\u7EC6\u817B\u3002\u5168\u65B0\u5E7F\u89D2\u6444\u50CF\u5934\uFF0C\u5149\u7EBF \u6355\u6349\u80FD\u529B\u589E\u52A0 47%\uFF0C\u63D0\u5347\u7167\u7247\u548C\u89C6\u9891\u7684\u54C1\u8D28\u3002 \u65B0\u589E\u4F20\u611F\u5668\u4F4D\u79FB\u5F0F\u5149\u5B66\u56FE\u50CF\u9632\u6296\u529F\u80FD\uFF0C\u5C31\u7B97\u624B\u4E0D\u7A33\uFF0C\u753B\u9762\u7167\u6837\u7A33\u3002 ");
function _sfc_render$i(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_a_button = resolveComponent("a-button");
...
var designer = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["render", _sfc_render$i]]);
...
const _hoisted_1$f = /* @__PURE__ */ createTextVNode("\u7F16\u8F91");
const _hoisted_2$b = /* @__PURE__ */ createTextVNode("iPhone 13 Pro");
const _hoisted_3$a = /* @__PURE__ */ createTextVNode("\u82F9\u679C\u5B98\u65B9");
const _hoisted_4$9 = /* @__PURE__ */ createTextVNode("2021\u5E7410\u67081\u65E5 18:00:00");
const _hoisted_5$7 = /* @__PURE__ */ createTextVNode("1.00");
const _hoisted_6$6 = /* @__PURE__ */ createTextVNode("$8299.00");
const _hoisted_7$6 = /* @__PURE__ */ createTextVNode("$8900.00");
const _hoisted_8$4 = /* @__PURE__ */ createTextVNode(" \u8D85\u5148\u8FDB\u53CC\u6444\u7CFB\u7EDF\uFF0C\u7CBE\u8FDB\u518D\u7CBE\u8FDB\uFF0C\u8D85\u5F3A\u8010\u7528\u6027\uFF0C\u8FB9\u8FB9\u89D2\u89D2\u9762\u9762\u4FF1\u5230\uFF0C \u8D85\u9AD8\u901F\u82AF\u7247\uFF0C\u53C8\u4E00\u6B21\u8D85\u8D8A\u81EA\u6211\uFF0C\u8D85\u52B2\u7EED\u822A\u5927\u63D0\u5347\uFF0C\u6BCF\u5929\u4E00\u8DEF\u633A\u4F60\uFF0C\u8D85\u74F7\u6676\u9762\u677F\uFF0C\u51ED\u786C\u5B9E\u529B\u8BA9\u73BB\u7483\u9762\u677F\u670D\u8F6F\uFF0C\u8010\u7528\u7684 \u5E73\u76F4\u8FB9\u7F18 \u8BBE\u8BA1 ");
const _hoisted_9$4 = /* @__PURE__ */ createBaseVNode("br", null, null, -1);
const _hoisted_10$4 = /* @__PURE__ */ createTextVNode(" \u5168\u65B0\u8D85\u5E7F\u89D2\u6444\u50CF\u5934\uFF0C\u8BA9\u7167\u7247\u6697\u90E8\u8868\u73B0\u66F4\u7EC6\u817B\u3002\u5168\u65B0\u5E7F\u89D2\u6444\u50CF\u5934\uFF0C\u5149\u7EBF \u6355\u6349\u80FD\u529B\u589E\u52A0 47%\uFF0C\u63D0\u5347\u7167\u7247\u548C\u89C6\u9891\u7684\u54C1\u8D28\u3002 \u65B0\u589E\u4F20\u611F\u5668\u4F4D\u79FB\u5F0F\u5149\u5B66\u56FE\u50CF\u9632\u6296\u529F\u80FD\uFF0C\u5C31\u7B97\u624B\u4E0D\u7A33\uFF0C\u753B\u9762\u7167\u6837\u7A33\u3002 ");
const _hoisted_11 = /* @__PURE__ */ createBaseVNode("br", null, null, -1);
const _hoisted_12 = /* @__PURE__ */ createTextVNode("\u786E\u8BA4\u53D1\u8D27");
...
var index$d = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["render", _sfc_render$h]]);
...
const _hoisted_1$e = /* @__PURE__ */ createBaseVNode("div", null, "Bound to parent", -1);
const _hoisted_2$a = /* @__PURE__ */ createBaseVNode("div", null, "Bound to parent", -1);
const _hoisted_3$9 = /* @__PURE__ */ createBaseVNode("div", null, "Bound to parent", -1);
const _hoisted_4$8 = /* @__PURE__ */ createBaseVNode("div", null, "Bound to parent", -1);
function _sfc_render$g(_ctx, _cache, $props, $setup, $data, $options) {
...
var index$c = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["render", _sfc_render$g]]);
...
var Table = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["render", _sfc_render$f], ["__scopeId", "data-v-9f3b78a8"]]);
...
const _hoisted_1$d = /* @__PURE__ */ createTextVNode(" \u9009\u62E9Exel\u6587\u4EF6 ");
...
var index$b = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["render", _sfc_render$e]]);
...
const _hoisted_1$c = /* @__PURE__ */ createTextVNode(" \u9009\u62E9\u6587\u4EF6 ");
function _sfc_render$d(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_a_button = resolveComponent("a-button");
  const _component_a_upload = resolveComponent("a-upload");
  return openBlock(), createElementBlock("div", null, [
...
var Breakpoint = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["render", _sfc_render$d]]);
...
const _hoisted_1$b = /* @__PURE__ */ createTextVNode("\u5927\u6587\u4EF6\u4E0A\u4F20");
function _sfc_render$c(_ctx, _cache, $props, $setup, $data, $options) {
...
var fileUpload = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["render", _sfc_render$c]]);
...
const _hoisted_3$8 = /* @__PURE__ */ createBaseVNode("div", { class: "ant-upload-text" }, "\u4E0A\u4F20", -1);
    ...
    default: withCtx(() => [
      createBaseVNode("div", _hoisted_1$a, [
        createVNode(_component_a_upload, {
          ...
          default: withCtx(() => [
            _ctx.fileList.length < 8 ? (openBlock(), createElementBlock("div", _hoisted_2$9, [
...
var fileUploadImg = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$b]]);
...
var index$a = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["render", _sfc_render$a], ["__scopeId", "data-v-67adc858"]]);
...
const _hoisted_1$8 = /* @__PURE__ */ _withScopeId$3(() => /* @__PURE__ */ createBaseVNode("h3", { class: "title" }, [
...
const _hoisted_2$8 = /* @__PURE__ */ _withScopeId$3(() => /* @__PURE__ */ createBaseVNode("br", null, null, -1));
const _hoisted_3$7 = /* @__PURE__ */ createTextVNode("\u7EAF\u7F16\u8F91\u6A21\u5F0F");
const _hoisted_4$6 = /* @__PURE__ */ createTextVNode("\u7F16\u8F91\u4E0E\u9884\u89C8\u6A21\u5F0F");
const _hoisted_5$6 = /* @__PURE__ */ createTextVNode("\u7EAF\u9884\u89C8\u6A21\u5F0F");
...
var index$9 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$9], ["__scopeId", "data-v-ce5ed5f4"]]);
...
const _hoisted_3$6 = /* @__PURE__ */ _withScopeId$2(() => /* @__PURE__ */ createBaseVNode("p", { style: { "margin-top": "10px", "margin-bottom": "0px" } }, "\u6211\u5E76\u4E0D\u5E0C\u671B\u751F\u6D3B\u53EF\u4EE5\u8FC7\u5F97\u987A\u5229\uFF0C\u4F46\u662F\u6211\u5E0C\u671B\u78B0\u5230\u56F0\u96BE\u7684\u65F6\u5019\uFF0C\u81EA\u5DF1\u662F\u4E2A\u5408\u683C\u7684\u5BF9\u624B\u2014\u2014\u7F8A\u5148\u751F", -1));
const _hoisted_4$5 = ["src"];
const _hoisted_5$5 = /* @__PURE__ */ _withScopeId$2(() => /* @__PURE__ */ createBaseVNode("p", { style: { "margin-top": "10px", "margin-bottom": "0px" } }, "\u4F60\u8D64\u624B\u7A7A\u62F3\u6765\u5230\u4EBA\u4E16\u95F4\uFF0C\u4E3A\u627E\u5230\u90A3\u7247\u6D77\u4E0D\u987E\u4E00\u5207", -1));
const _hoisted_6$5 = /* @__PURE__ */ _withScopeId$2(() => /* @__PURE__ */ createBaseVNode("button", { class: "btn" }, "\u4E86\u89E3\u66F4\u591A", -1));
...
var index$8 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$8], ["__scopeId", "data-v-74cb7798"]]);
...
const _hoisted_1$6 = /* @__PURE__ */ createTextVNode("JSON\u6570\u636E\u6253\u5370");
const _hoisted_2$6 = /* @__PURE__ */ createTextVNode("JSON\u6570\u636E\u6253\u5370\u6307\u5B9A\u5B57\u6BB5name\uFF0Cemail ");
const _hoisted_3$5 = /* @__PURE__ */ createTextVNode("\u5355\u5F20\u56FE\u7247\u6253\u5370");
const _hoisted_4$4 = /* @__PURE__ */ createTextVNode("\u591A\u5F20\u5F20\u56FE\u7247\u6253\u5370");
const _hoisted_5$4 = { class: "invoice-img" };
const _hoisted_6$4 = ["src"];
const _hoisted_7$4 = ["src"];
const _hoisted_8$3 = ["src"];
const _hoisted_9$3 = /* @__PURE__ */ createTextVNode("Html\u6253\u5370");
const _hoisted_10$3 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("div", {
  class: "dom",
  id: "htmlPrint"
}, [
...
var index$7 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$7], ["__scopeId", "data-v-6f222589"]]);
...
const _hoisted_1$5 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("h3", { class: "title" }, [
  /* @__PURE__ */ createTextVNode("\u5B98\u65B9API: "),
  /* @__PURE__ */ createBaseVNode("a", {
...
const _hoisted_2$5 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", null, [
  /* @__PURE__ */ createBaseVNode("div", { id: "editor-container" })
], -1));
const _hoisted_3$4 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("br", null, null, -1));
const _hoisted_4$3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("h3", { class: "title" }, "\u9884\u89C8", -1));
const _hoisted_5$3 = ["innerHTML"];
const _hoisted_6$3 = /* @__PURE__ */ createTextVNode("\u83B7\u53D6\u6240\u6709\u5185\u5BB9");
const _hoisted_7$3 = /* @__PURE__ */ createTextVNode("\u6253\u5370Quill\u5B9E\u5217");
...
var index$6 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$6], ["__scopeId", "data-v-00786463"]]);
...
const _hoisted_1$4 = /* @__PURE__ */ createTextVNode("socket");
const _hoisted_2$4 = /* @__PURE__ */ createBaseVNode("pre", null, [
...
const locaViews = { "/src/packages/views/about/index.vue": __glob_1_0, "/src/packages/views/admire/index.vue": __glob_1_1, "/src/packages/views/async/index.vue": __glob_1_2, "/src/packages/views/error/403.vue": __glob_1_3, "/src/packages/views/error/404.vue": __glob_1_4, "/src/packages/views/error/500.vue": __glob_1_5, "/src/packages/views/error/index.vue": __glob_1_6, "/src/packages/views/home/dynamic.vue": __glob_1_7, "/src/packages/views/home/index.vue": __glob_1_8, "/src/packages/views/home/project-info.vue": __glob_1_9, "/src/packages/views/home/returns.vue": __glob_1_10, "/src/packages/views/home/ripple.vue": __glob_1_11, "/src/packages/views/login/index.vue": __glob_1_12, "/src/packages/views/permit/index.vue": __glob_1_13, "/src/packages/views/sys/menu.vue": __glob_1_14, "/src/packages/views/test/index.vue": __glob_1_15, "/src/packages/views/animation/mojs/index.vue": __glob_1_16, "/src/packages/views/chart/echarts/demo1.vue": __glob_1_17, "/src/packages/views/chart/echarts/demo2.vue": __glob_1_18, "/src/packages/views/chart/echarts/demo3.vue": __glob_1_19, "/src/packages/views/chart/echarts/demo4.vue": __glob_1_20, "/src/packages/views/chart/echarts/demo5.vue": __glob_1_21, "/src/packages/views/chart/echarts/demo6.vue": __glob_1_22, "/src/packages/views/chart/echarts/index.vue": __glob_1_23, "/src/packages/views/chart/g2/index.vue": __glob_1_24, "/src/packages/views/chart/g2plot/index.vue": __glob_1_25, "/src/packages/views/module/debug/index.vue": __glob_1_26, "/src/packages/views/module/descriptions/designer.vue": __glob_1_27, "/src/packages/views/module/descriptions/index.vue": __glob_1_28, "/src/packages/views/module/draggable/index.vue": __glob_1_29, "/src/packages/views/module/exel/index.vue": __glob_1_30, "/src/packages/views/module/exel/table.vue": __glob_1_31, "/src/packages/views/module/fileUpload/breakpoint.vue": __glob_1_32, "/src/packages/views/module/fileUpload/fileUpload.vue": __glob_1_33, "/src/packages/views/module/fileUpload/fileUploadImg.vue": __glob_1_34, "/src/packages/views/module/iframe/index.vue": __glob_1_35, "/src/packages/views/module/markdown/index.vue": __glob_1_36, "/src/packages/views/module/marquee/index.vue": __glob_1_37, "/src/packages/views/module/print/index.vue": __glob_1_38, "/src/packages/views/module/rich/index.vue": __glob_1_39, "/src/packages/views/module/util/index.vue": __glob_1_40, "/src/packages/views/sys/menu/add.vue": __glob_1_41, "/src/packages/views/sys/menu/edit.vue": __glob_1_42, "/src/packages/views/vxe-table/base/index.vue": __glob_1_43, "/src/packages/views/vxe-table/edit-table/index.vue": __glob_1_44, "/src/packages/views/vxe-table/great-table/index.vue": __glob_1_45, "/src/packages/views/vxe-table/verify-table/index.vue": __glob_1_46, "/src/packages/views/module/icon/iconfont/index.vue": __glob_1_47 };
...
const setAddRoute = (app2, router2) => {
  var _a;
  const { views = [] } = ((_a = app2.config.globalProperties.$plugin) == null ? void 0 : _a.routerView) || {};
...
const routes = [
  {
    path: "/",
    name: "admin",
    component: () => __vitePreload(() => import("./index-f40a9b6a.js"), true ? ["assets/js/index-f40a9b6a.js","assets/static/index-0ffb8169.css","assets/static/minireset.css-9e96f7bb.css","assets/js/vuex-bb2f5e5b.js","assets/js/@vue-f3ca1b6f.js","assets/js/axios-c5bbbefe.js","assets/js/vue-router-abde8f4b.js","assets/js/@ant-design-10c9abc6.js","assets/js/@ctrl-61649d3f.js","assets/js/ant-design-vue-8621340c.js","assets/static/ant-design-vue-10703463.css","assets/js/@babel-2ac7e3e5.js","assets/js/regenerator-runtime-5031f1e2.js","assets/js/vue-types-e39ece55.js","assets/js/omit.js-8aeb4109.js","assets/js/resize-observer-polyfill-41c23942.js","assets/js/lodash-es-23e4464f.js","assets/js/moment-f39140d2.js","assets/js/dom-align-9919c820.js","assets/js/array-tree-filter-2d8f4dff.js","assets/js/shallow-equal-751ba107.js","assets/js/async-validator-f2a6c09d.js","assets/js/scroll-into-view-if-needed-c253da67.js","assets/js/compute-scroll-into-view-f5b2517a.js","assets/js/warning-cc941e3b.js","assets/js/dom-scroll-into-view-5e57096f.js","assets/js/nprogress-e54c853a.js","assets/static/nprogress-4f85ad69.css","assets/js/store-e22b25f7.js","assets/js/lodash-0fe20078.js","assets/js/@antv-15af26e6.js","assets/js/tslib-ca86d7fb.js","assets/js/detect-browser-3458fdcd.js","assets/js/gl-matrix-41ea8061.js","assets/js/d3-ease-a82c91a3.js","assets/js/d3-interpolate-d19ec80d.js","assets/js/d3-color-9ef60408.js","assets/js/d3-timer-29ea6e13.js","assets/js/fecha-7b6e87e1.js","assets/js/size-sensor-ba076d7e.js","assets/js/d3-regression-e5d6f1c6.js","assets/js/pdfast-e3a16ab3.js","assets/js/fmin-29e03d32.js","assets/js/d3-hierarchy-82895eaf.js","assets/js/crypto-js-33836c9f.js","assets/js/@mojs-1ff6c968.js","assets/js/echarts-fffd6d3a.js","assets/js/zrender-cdd1d9d2.js","assets/js/xlsx-be779d30.js","assets/js/@kangc-04158a4a.js","assets/static/@kangc-998d762b.css","assets/js/vue-99b9a158.js","assets/js/highlight.js-5d1de029.js","assets/js/vue3-marquee-3097e0d6.js","assets/js/print-js-49781bfc.js","assets/js/quill-f4ba861e.js","assets/static/quill-d738b1f9.css","assets/js/@vueuse-fe55e91e.js","assets/js/vxe-table-57902609.js","assets/static/vxe-table-b988f8bb.css","assets/js/xe-utils-a3a4c73c.js","assets/js/@soerenmartius-2f8ee501.js","assets/js/@braks-1429c1f4.js","assets/js/mockjs-ecfa51ef.js","assets/js/mitt-e6c86215.js"] : void 0),
    children: [
      { path: "", redirect: "home" },
      {
        path: "/home",
...
Mock.mock("/api/yxs/userinfo", "post", (options) => {
  let { body } = options;
  let type = "admin";
...
export { Contextmenu as C, _export_sfc as _, apiAppRouter as a, apiNotice as b, _imports_0$1 as c, last as d, find as f, install as i, locaStore as l, toTree as t };
