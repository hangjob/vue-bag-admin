...
function clientToLocal(el, e2, out2, calculate) {
  ...
  } else if (env$1.browser.firefox && env$1.browser.version < "39" && e2.layerX != null && e2.layerX !== e2.offsetX) {
    out2.zrX = e2.layerX;
    out2.zrY = e2.layerY;
...
var Transformable = function() {
  ...
  Transformable2.prototype.needLocalTransform = function() {
    return isNotAroundZero$1(this.rotation) || isNotAroundZero$1(this.x) || isNotAroundZero$1(this.y) || isNotAroundZero$1(this.scaleX - 1) || isNotAroundZero$1(this.scaleY - 1);
  };
...
var ZRender = function() {
  function ZRender2(id, dom, opts) {
    ...
    var handerProxy = !env$1.node && !env$1.worker ? new HandlerProxy(painter.getViewportRoot(), painter.root) : null;
...
function fromArc(x, y, rx, ry, startAngle, endAngle, anticlockwise, min3, max3) {
  ...
  if (diff2 % PI2$6 < 1e-4 && diff2 > 1e-4) {
    min3[0] = x - rx;
    min3[1] = y - ry;
    max3[0] = x + rx;
    max3[1] = y + ry;
...
var PathProxy = function() {
  ...
  PathProxy2.prototype._dashedLineTo = function(x1, y1) {
    ...
    var dx = x1 - x0;
    var dy = y1 - y0;
    var dist2 = mathSqrt$3(dx * dx + dy * dy);
    var x = x0;
    var y = y0;
...
function buildPath$1(ctx, shape) {
  ...
  if (startAngle === endAngle) {
    ...
    arc = mathAbs(tmpAngles2[0] - tmpAngles2[1]);
  }
  var x = shape.cx;
  var y = shape.cy;
...
function smoothSpline(points2, isLoop) {
  var len2 = points2.length;
  var ret = [];
  var distance$1 = 0;
  for (var i = 1; i < len2; i++) {
    distance$1 += distance(points2[i - 1], points2[i]);
  }
...
function setTransform(svgEl, m2) {
  if (m2) {
    attr(svgEl, "transform", "matrix(" + round3(m2[0]) + "," + round3(m2[1]) + "," + round3(m2[2]) + "," + round3(m2[3]) + "," + round4(m2[4]) + "," + round4(m2[5]) + ")");
  }
}
...
var CanvasPainter = function() {
  ...
  CanvasPainter2.prototype.pathToImage = function(path, dpr2) {
    dpr2 = dpr2 || this.dpr;
...
export { Point$1 as $, subPixelOptimize as A, identity as B, mul as C, invert as D, Circle$1 as E, Ellipse$1 as F, Polygon$1 as G, Polyline$1 as H, Rect$1 as I, Line$1 as J, BezierCurve$1 as K, LRU$1 as L, Arc$1 as M, extendFromString as N, Group$1 as O, Path$1 as P, ZRText$1 as Q, Ring$1 as R, Sector$1 as S, Transformable$1 as T, IncrementalDisplayable$1 as U, CompoundPath$1 as V, LinearGradient$1 as W, RadialGradient$1 as X, BoundingRect$1 as Y, ZRImage$1 as Z, OrientedBoundingRect$1 as _, assert as a, sub as a$, trim as a0, isFunction as a1, merge as a2, clone$3 as a3, mixin as a4, normalizeCssArray as a5, isNumber as a6, curry as a7, isTypedArray as a8, filter as a9, dist$1 as aA, lerp$1 as aB, quadraticProjectPoint as aC, cubicProjectPoint as aD, normalizeRadian as aE, SVGPainter$1 as aF, CanvasPainter$1 as aG, cubicRootAt as aH, cubicAt as aI, lerp as aJ, retrieve3 as aK, retrieve as aL, rotate as aM, find as aN, isMiddleOrRightButtonOnMouseUpDown as aO, stop as aP, Displayable$1 as aQ, copy as aR, create as aS, copy$1 as aT, mergeAll as aU, translate as aV, scale as aW, fastLerp as aX, modifyHSL as aY, modifyAlpha as aZ, clone$2 as a_, bind as aa, setAsPrimitive as ab, concatArray as ac, noop as ad, calculateTextPosition as ae, WeakMap$1 as af, createCanvas as ag, brushSingle as ah, fromPoints as ai, min$1 as aj, max$1 as ak, contain as al, parseXML as am, parseSVG as an, makeViewBoxTransform as ao, Eventful$1 as ap, init as aq, parse as ar, stringify as as, sort as at, registerPainter as au, slice as av, eqNaN as aw, parsePercent as ax, getBoundingRect as ay, PathProxy$1 as az, isStringSafe as b, len as b0, normalize as b1, set as b2, scaleAndAdd as b3, create$1 as b4, quadraticSubdivide as b5, quadraticAt as b6, distSquare as b7, clone$1 as b8, quadraticDerivativeAt as b9, containStroke$4 as ba, containStroke$2 as bb, cloneValue as bc, isDom as bd, addEventListener as be, normalizeEvent as bf, toHex as bg, transformLocalCoord as bh, isRegExp as bi, isCombineMorphing as bj, morphPath as bk, combineMorph as bl, separateMorph as bm, clonePath$1 as bn, createHashMap as c, isArray as d, each as e, isString as f, indexOf as g, env$1 as h, isObject as i, interpolateNumber as j, extend as k, inherits as l, map as m, createObject as n, isArrayLike as o, keys as p, lift as q, reduce as r, retrieve2 as s, hasOwn as t, defaults as u, applyTransform as v, createFromString as w, mergePath as x, subPixelOptimizeLine as y, subPixelOptimizeRect as z };
