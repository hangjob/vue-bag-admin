<template>
  <div class="p-6 bg-white dark:bg-[#0A1120] rounded-2xl shadow-sm min-h-[calc(100vh-120px)] border border-gray-100 dark:border-gray-800 max-w-4xl mx-auto">
    ...
    <div class="flex items-center gap-4 mb-8">
      ...
      <h2 class="text-2xl font-bold text-slate-800 dark:text-slate-200">编辑商品</h2>
    </div>
    ...
    <form class="space-y-8" @submit.prevent>
      ...
      <div class="flex justify-end gap-4 pt-6 mt-8 border-t border-gray-100 dark:border-gray-800">
        ...
        <button type="button" class="px-6 py-2.5 bg-gradient-to-r from-orange-500 to-rose-500 text-white rounded-lg hover:shadow-lg hover:shadow-orange-500/30 transition-all font-bold">保存修改</button>
      </div>
    </form>
  </div>
</template>
