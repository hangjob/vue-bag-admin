<template>
    <section class="section section-container">
        ...
        <n-grid  cols="24" x-gap="30" y-gap="30" item-responsive responsive="screen">
            <n-grid-item span="24 m:24 l:12" class="wow animate__animated animate__fadeInLeft" data-wow-duration="1.0s" data-wow-delay="0.2s" style="margin-top: 50px">
                <p>
            ...
            <n-grid-item span="24 m:24 l:12" class="wow animate__animated animate__fadeInRight" data-wow-duration="1.0s" data-wow-delay="0.2s" style="margin-top: 50px">
                <div class="skill">
                    <div class="skill-count">
                        <n-progress style="width: 120px;flex-shrink: 0" type="circle" color="#20a0ff" status="success" :percentage="80" />
                    ...
                    <div class="skill-count">
                        <n-progress style="width: 120px;flex-shrink: 0" color="#ff4949" type="circle" status="success" :percentage="90" />
                        <div style="margin-left: 10px">
                            <h6>表单</h6>
                    ...
                    <div class="skill-count">
                        <n-progress style="width: 120px;flex-shrink: 0" color="#e6a23c" type="circle" status="success" :percentage="80" />
                        <div style="margin-left: 10px">
                            <h6>特性</h6>
